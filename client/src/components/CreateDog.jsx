        ...
        <form onSubmit = {handleSubmit}>
            <div className={style.background}>
                <ul>
                    ...
                    <input className={style.input} key="height" type="text" name="height" placeholder="Insert height... Cm" onChange={handleInputChange} value={input.height}/>
                    ...
                    <input className={style.input} key="weight" type="text" name="weight" placeholder="Insert weight... Kg" onChange={handleInputChange} value={input.weight}/>
